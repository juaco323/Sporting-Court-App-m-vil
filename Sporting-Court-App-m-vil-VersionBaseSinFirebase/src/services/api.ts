...
class ApiService {
  ...
  async loginWithFirebase(data: { firebase_uid: string; email: string; full_name: string }): Promise<AuthResponse> {
    const response = await this.api.post<AuthResponse>('/auth/firebase/login', data);
  ...
  async registerWithFirebase(data: { firebase_uid: string; email: string; full_name: string; rut: string }): Promise<AuthResponse> {
    const response = await this.api.post<AuthResponse>('/auth/firebase/register', data);
